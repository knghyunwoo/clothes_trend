...
def wconcept_women(endpage=14):
    #접근할 페이지 번호
    pageNum = 1

    #저장할 이미지 경로 및 이름 (data폴더에 face0.jpg 형식으로 저장)
    imageNum = 0
    imageStr = "crawled_images/wconcept_women_crawled/best"
    path = 'crawled_images/wconcept_women_crawled/'
    ...
    while pageNum < endpage:
        url = "https://www.wconcept.co.kr/Women/0010?sort=1&page="
        url = url + str(pageNum)
